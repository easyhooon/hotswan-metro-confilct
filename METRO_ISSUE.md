...
This first looked like a HotSwan issue because I hit it while applying a HotSwan deploy: Compose captured a `NoSuchMethodError`, the process stayed alive, and the activity showed a blank white screen. After inspecting the generated bytecode, the mismatch appears to be between Metro-generated classes:
...
HotSwan was involved in the original trigger path, but the bytecode mismatch itself appears to be between Metro-generated classes. My current suspicion is generated graph invalidation / incremental compilation / build cache behavior around assisted factory signature changes.
